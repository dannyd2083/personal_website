        ...
        <div>
            ...
            <div  className=" grid lg:grid-cols-2 gap-12 items-center max-w-[1440px] mx-auto min-h-screen">
                ...
                <h1 className= "text-5xl text-regal-yellow font-AbrilFatface mt-10 mb-10 left-0" > About Me</h1>
                    <div className="text-2xl mr-10"><p>Greetings, I'm Danny, a <span className="text-regal-yellow text-2xl font-bold"> Computer Science </span>student at the <span className="text-regal-yellow text-2xl font-bold"> University of British Columbia in Vancouver </span>.
